...
<div class="my-orders">
							...
							<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
								<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
									...
									<?php elseif ( 'order-total' === $column_id ) : ?>
										...
										echo $order->get_formatted_order_total(); //printf( _n( '%1$s for %2$s item', '%1$s for %2$s items', $item_count, 'woocommerce' ), $order->get_formatted_order_total(), $item_count );
										?>
	...
	<div class="my-orders-table-wrap-on-mobile">
		<?php if ( $has_orders ) : ?>
					<?php foreach ( $customer_orders->orders as $customer_order ) :
						$order      = wc_get_order( $customer_order );
						$item_count = $order->get_item_count();
						...
						<table class="table-order">
							<tr><th>Заказы</th><td>№<?php echo $order->get_order_number(); ?></td></tr>
							<tr><th>Дата</th><td><?php echo esc_html( wc_format_datetime( $order->get_date_created() ) ); ?></td></tr>
							<tr><th>Статус</th><td><?php echo wc_get_order_status_name( $order->get_status() ); ?></td></tr>
							<tr><th>Итого</th><td><?php echo $order->get_formatted_order_total(); ?></td></tr>
							<tr><th>Действия</th><td><input type="submit" class="btn-form btn-view" data-order-id="<?php echo $order->get_order_number(); ?>" value="Просмотр"></td></tr>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
