                    ...
                    <div class="banner-our-production-content">	
                        ...
                        <div class="banner-our-production-content-320" id="banner-our-production-content-320">
                            <div class="banner-our-production-menu banner-our-production-menu1">
                                <div class="box">
                                    <a href="#" class="prof-link-active">Профиль</a>
                                    <a href="#">Мои заказы</a>
            ...
            <div class="wrap-in wrap-in-margin-bottom">
                ...
                <!-- <div class="privat-cab-nav-box">
                    ...
                    <nav class="privat-cab-nav">
                        <ul>
                            <li class="prof-link-active"><a href="#">Профиль</a></li>
                            <li><a href="page9-orders.html">Мои заказы</a></li>
                            <li><a href="page10-wishes.html">Мои желания</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="my-profile">
                    ...
                    <div class="wrap-profile-form">
                        <form action="#" method='get'>
                            ...
                            <p>Смена пароля</p>
                            <div><input class="input-my-profile required oldPassword" type="password" placeholder="Действующий пароль"  /></div>
                            <div><input class="input-my-profile required password" id="password1" type="password" placeholder="Новый пароль"  /></div>
                            <div><input class="input-my-profile required passwordConfirmation" id="password2" type="password" placeholder="Подтвердите новый пароль" /></div>
                            <input type="submit" class="btn-form" value="Сохранить изменения" />
                        </form>
                    </div>
                </div> -->
