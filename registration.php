                ...
                <div class="wrap-in wrap-in-margin-top wrap-in-margin-bottom">
                    ...
                    <div class="wrap-form-registry">
                        <form action="#" data-action="registration">
                            ...
                            <input class="input-my-profile required password" type="password" name="password_1" placeholder="Введите пароль" />
                            <div><input class="input-my-profile required passwordConfirmation" type="password" name="password_2" placeholder="Введите пароль повторно" /></div>
